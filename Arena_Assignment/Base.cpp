...
/*****************************************************************
** Description: Default Constructor for Base
** Parameters: None
******************************************************************/
Base::Base()
{
...
**  Parameters: 1 integer
************************************************************/
void Base::setAchillesCut(bool achillesState)
{
...
**  Parameters: 1 integer
************************************************************/
int Base::rollDice(int dice, int sides)
{
...
int Base::attack(int die, int sides)
{
	// Set variables
	int roll;				// Roll
...
int Base::defense(int die, int sides, int armor)
{
	// Set variables
	int roll;
